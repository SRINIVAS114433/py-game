...
def your_score(score):
    ...
    dis.blit(value, [0,0]) # usedd to draw or create changes


def our_snake(snake_block, snake_list):
    for x in snake_list:
        paygame.draw.rect(dis, black, [x[0], snake_block, snake_block])
...
def gameLoop():
    ...
    while not game_over:
        while game_close==True:
            dis.fill(pink)
            lost="you lost the game, press C to play agian or Q to quit"
            message(lost, red)
